# Acquisition Brief â€” contracts-rb

**Date:** 2026-09-22  
**Repository:** https://github.com/theworker02/contracts-rb  
**Default branch:** `main`  
...
This project is **proprietary**. Production use, redistribution, and commercial deployment require a written commercial license or completed acquisition. See [LICENSE](./LICENSE) and [ACQUISITION.md](./ACQUISITION.md). Contact [@theworker02](https://github.com/theworker02). <a href="https://github.com/theworker02/contracts-rb"> <img src="assets/contracts-rb-logo.png" alt="contracts-rb" width="760">

**Why a buyer cares:** contracts-rb packages transferable product IP â€” source, docs, in-repo brand assets, and a diligence room under `docs/acquisition/` â€” under a clear proprietary posture so diligence can proceed without mistaking the repo for open source.
...
| Item | Detail |
|------|--------|
| Product | contracts-rb |
| Repo | `theworker02/contracts-rb` |
| Language | Ruby |
...
Teams evaluating contracts-rb typically need either (a) a commercial right to run or embed it, or (b) outright ownership of the Product IP for strategic build-out. Public GitHub visibility without a proprietary license creates false assumptions about free production use. This brief and the linked data room make the commercial path explicit.
